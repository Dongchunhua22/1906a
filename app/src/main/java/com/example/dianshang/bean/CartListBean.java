...
public  class CartListBean {
            ...
            private boolean editChecked;//编辑状态细复选框选中与否
            private boolean isServerDelete;
            @Generated(hash = 467813457)
            public CartListBean(Long id, int user_id, String session_id, int goods_id, String goods_sn,
                    int product_id, String goods_name, int market_price, int retail_price, int number,
                    String goods_specifition_name_value, String goods_specifition_ids, int checked,
                    String list_pic_url, boolean editChecked, boolean isServerDelete) {
                this.id = id;
