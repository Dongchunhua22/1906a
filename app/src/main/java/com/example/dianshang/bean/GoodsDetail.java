...
public class GoodsDetail {
    /*2.封装实体类 implements MultiItemEntity
   ui展示的数据，itemType*/
    public static class GoodsDetailItemBean implements MultiItemEntity {
        //定义子条目有多少种类型
        public static final int TYPE_BANNER = 0;//顶部banner+名称+价格
        public static final int TYPE_HTML = 1;//h5
        public static final int TYPE_TITLE = 2;//标题
        public static final int TYPE_ISSUE = 3;//常见问题
        public static final int TYPE_GOODS_LIST = 4;//关联商品列表
